...
| 文档 | 描述 | 受众 |
|------|------|------|
| [架构设计](./architecture.md) | 系统架构、层次划分、模块依赖图 | 架构师、Tech Lead |
| [技术栈](./tech-stack.md) | Python 技术选型及理由 | 所有开发者 |
| [模块规范](./modules.md) | 每个模块的职责、接口、内部结构 | 开发者 |
| [数据流](./data-flows.md) | 关键路径时序图（用户输入→工具执行→响应） | 开发者 |
| [实施计划](./phases.md) | 分阶段开发计划，含优先级和依赖 | PM、Tech Lead |
| [API 规范](./api-specs.md) | 模块间内部 API 契约 | 开发者 |
| [测试策略](./testing-strategy.md) | 单元/集成/E2E 测试方案 | QA、开发者 |
